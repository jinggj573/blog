...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    SrvResourcesMapper resourcesMapper;

    @Autowired
    private StringRedisTemplate stringRedisTemplate;

    @Override
    public BgBaseUser findUser(String userName) {
        return userMapper.selectOne(new QueryWrapper<BgBaseUser>().eq("user_name",userName));
    }
     ...
     */
    @Override
    public CommonResult login(BgBaseUser user,String captchaCode,String captchaKey) {
